	...
	<array>
		<dict>
			...
			<dict>
				...
				<key>AMCommandLineReceiverAcceptsStdin</key>
				<true/>
				<key>AMProvides</key>
				<dict>
					<key>Container</key>
				...
				<dict>
					...
					<string>/usr/bin/python3 "${TRANSLATE_SCRIPT}"</string>
...
cat > "$REPLACE_WORKFLOW_DIR/Contents/Info.plist" << 'PLIST_EOF'
<?xml version="1.0" encoding="UTF-8"?>
<!DOCTYPE plist PUBLIC "-//Apple//DTD PLIST 1.0//EN" "http://www.apple.com/DTDs/PropertyList-1.0.dtd">
<plist version="1.0">
<dict>
...
cat > "$REPLACE_WORKFLOW_DIR/Contents/document.wflow" << WFLOW_EOF
<?xml version="1.0" encoding="UTF-8"?>
<!DOCTYPE plist PUBLIC "-//Apple//DTD PLIST 1.0//EN" "http://www.apple.com/DTDs/PropertyList-1.0.dtd">
<plist version="1.0">
<dict>
	...
	<array>
		<dict>
			...
			<dict>
				...
				<dict>
					<key>COMMAND_STRING</key>
					<string>/usr/bin/python3 "${TRANSLATE_SCRIPT}" --replace</string>
					<key>CheckedForUserDefaultShell</key>
					<true/>
					<key>inputMethod</key>
					<integer>0</integer>
